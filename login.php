...
?>
<div id="page" class="col-md-5 col-md-offset-4">

	<form class="form loginform" method="POST" action="authenticate.php">
		<div class="login-panel panel panel-default" align="center">
            <img src="logo.png" width="220" height="150" alt="ccCOVID_19" />
            <div class="panel-heading"><h4 align="center"><i>Nerve Center Attendance Register</i></h4></div>
