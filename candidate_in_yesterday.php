...
$candidates = $db->where('check_in_date', $yesterday);
...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="page-header">Check-In Yesterday </h1>
        ...
        <tbody>
            <?php foreach ($candidates as $row) : ?>
                <tr>
	                ...
	                <td align="center">
                    <a href="checked_in_candidate.php?candidate_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 4px;"><span class="glyphicon glyphicon-eye-open"></span>
				</tr>
            <?php endforeach; ?>      
        </tbody>
    </table>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="candidate_in_yesterday.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
