...
$today = date('Y-m-d');
$candidates = $db->where('check_in_date', $today);
...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="page-header">Checked-In Today</h1>
        </div>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; ++$i) {
                ...
                echo '<li'.$li_class.'><a href="candidate_in_today.php'.$http_query.'&page='.$i.'">'.$i.'</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
