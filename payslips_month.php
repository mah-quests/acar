...
$candidates = $db->join("payslips pay", "pay.id_number=can.id_number", "LEFT");
$candidates = $db->where('payslip_date', Array ($firstDay, $lastDay), 'BETWEEN');
$candidates = $db->get("candidates can",null);
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="payslips_month.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
