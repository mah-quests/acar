...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="page-header">Partner Representatives Monthly Reports</h1>
        </div>
    </div>
    ...
    <table class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th>Days Checked <br> In (this month)</th>
                <th>Days Checked <br> Out (this month)</th>
                <th>Details</th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($candidates as $row) : ?>
                <tr>
                    ...
                    <td align="center"><?php 
                        ...
                        echo numberOfDaysCandidateWorked($id_number,'time_in') 
                        ?> 
                    </td>
                    <td align="center"><?php 
                        $id_number = $row['id_number'];
                        echo numberOfDaysCandidateWorked($id_number,'time_out') 
                        ?> 
                    </td>                    
	                <td align="center">
                    <a href="candidate_checked_month.php?candidate_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 4px;"><span class="glyphicon glyphicon-eye-open"></span>
                    </td>
				</tr>
            <?php endforeach; ?>      
        </tbody>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="candidate_report.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
