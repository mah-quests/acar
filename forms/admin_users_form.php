<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
                ...
                <input type="text" name="id_number" placeholder="ID number " class="form-control" required="" autocomplete="off">
            </div>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
         ...
         <!--   <div class="radio">
                <label>
                    <input type="radio" name="admin_type" value="candidate" required="" <?php echo ($edit && $admin_account['admin_type'] =='candidate') ? "checked": "" ; ?>/> Candidate
                </label>
            </div>-->
        </div>
    </div>
