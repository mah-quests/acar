...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="page-header">Generate Payslip</h1>
        </div>
    </div>
        ...
        <tbody>
            <?php foreach ($candidates as $row) : ?>
                <tr>
                    ...
                    <td align="center">
                    <a href="payslip_input.php?candidate_id=<?php echo $row['id'] ?>&operation=create" class="btn btn-primary" style="margin-right: 4px;"><span class="glyphicon glyphicon-play-circle"></span></a></td>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="generate_payslip.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
